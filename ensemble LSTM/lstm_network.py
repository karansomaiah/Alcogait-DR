...
def LSTM_Network(_X, config):
    ...
    lstm_fw_cell = tf.contrib.rnn.MultiRNNCell([tf.contrib.rnn.BasicLSTMCell(config.n_hidden, forget_bias=0.5, state_is_tuple=True) for _ in range(2)], state_is_tuple=True)
